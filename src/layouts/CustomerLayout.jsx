...
export default function CustomerLayout() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] font-sans text-gray-800 flex flex-col relative">
          ...
          {showPromo && (
            <div className="bg-[#2D982A] text-white relative flex justify-center items-center py-1.5 px-4">
              ...
              <div className="text-center leading-snug">
                ...
                <p className="text-[13px] font-light mt-0.5">Đăng ký thành viên ngay <a href="/register" className="underline font-normal hover:text-gray-200">tại đây!</a></p>
              </div>
            </div>
          )}
            ...
            <div className="w-full px-6 xl:px-16 py-3 flex items-center justify-between">
              ...
              <div className="flex-shrink-0 flex flex-col items-end ml-4">
                <div className="flex items-center space-x-6 mb-2">
                  ...
                  <div className="flex items-center space-x-1.5 cursor-pointer hover:text-[#2D982A] group">
                ...
                <div className="flex items-center space-x-3">
                  <button className="flex items-center border cursor-pointer border-gray-300 rounded-lg px-3.5 py-1.5 hover:bg-gray-50 transition-colors">
                  ...
                  <button className="flex items-center border cursor-pointer border-gray-300 rounded-lg px-4 py-2 hover:bg-gray-50 transition-colors">
      ...
      {/* =========================================================
          NỘI DUNG ĐỘNG (Trang chủ, Chi tiết, Giỏ hàng)
          ========================================================= */}
      ...
      {/* =========================================================
          FOOTER CHUẨN XỊN 100% THEO THIẾT KẾ (image_980bc5)
          ========================================================= */}
      {!isRegisterPage && (
        <footer className="w-full bg-white mt-auto flex flex-col">
          
          {/* 1. KHỐI: MUA HÀNG DỄ DÀNG */}
          ...
          {/* Khoảng trắng cách điệu */}
          <div className="h-16 bg-white w-full border-t border-gray-100"></div>

          {/* 2. KHỐI: 4 TÍNH NĂNG (Nền xanh nhạt, icon xanh trần - Không hộp trắng) */}
          ...
          <div className="bg-white py-12 px-6 xl:px-16 w-full max-w-[1920px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <p className="text-[13px] text-gray-700 leading-relaxed"><strong>Số ĐKKD 12346789</strong> cấp 04/11/2018 tại Sở Kế hoạch Đầu tư Hà Nội</p>
              <p className="text-[13px] text-gray-700"><strong>Địa chỉ:</strong> XX Hoàng Mai, Hà Nội</p>
              <p className="text-[13px] text-gray-700"><strong>Email:</strong> nhathuocthaiduong@mail.com</p>
              
              <div className="flex flex-wrap items-center gap-3 pt-4">
                {IMAGES.NCS && <img src={IMAGES.NCS} alt="NCS" className="h-8 object-contain" />}
                {IMAGES.BO_CONG_THUONG && <img src={IMAGES.BO_CONG_THUONG} alt="BCT" className="h-8 object-contain" />}
                {IMAGES.DMCA && <img src={IMAGES.DMCA} alt="DMCA" className="h-8 object-contain" />}
              </div>
            </div>
            ...
            <div className="lg:col-span-3">
              ...
              <ul className="space-y-3">
                {['Giới thiệu nhà thuốc', 'Hướng dẫn mua hàng Online', 'Chính sách giao hàng', 'Chính sách thanh toán', 'Chính sách đổi trả, bảo hành', 'Chính sách bảo mật', 'Thể lệ tích điểm thành viên'].map((link, idx) => (
            ...
            <div className="lg:col-span-2">
              <h3 className="font-bold text-[15px] text-gray-900 mb-6 uppercase">DANH MỤC SẢN PHẨM</h3>
              <ul className="space-y-3">
                {['Thuốc', 'Thực phẩm chức năng', 'Dược - Mỹ phẩm', 'Thiết bị y tế'].map((link, idx) => (
                  <li key={idx}><a href="#" className="text-[13px] text-gray-600 hover:text-[#2D982A]">{link}</a></li>
                ))}
              </ul>
            </div>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="flex items-center space-x-3">
                {IMAGES.NAPAS && <img src={IMAGES.NAPAS} alt="Napas" className="h-8 object-contain rounded" />}
                {IMAGES.MOMO && <img src={IMAGES.MOMO} alt="Momo" className="h-8 object-contain rounded" />}
              </div>
            </div>
